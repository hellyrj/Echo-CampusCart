...
const VendorApplication = () => {
        ...
        return (
            <div className="min-h-screen" style={{ backgroundColor: theme.background }}>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="rounded-lg shadow-lg p-8 text-center" style={{ backgroundColor: theme.surface }}>
                        <div className="w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center" style={{ backgroundColor: theme.accent + '20' }}>
                            <svg className="w-8 h-8" style={{ color: theme.accent }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <h2 className="text-2xl font-bold mb-4" style={{ color: theme.text.primary }}>Application Submitted!</h2>
                        ...
                        <div className="space-y-4">
                            <button
                                ...
                                style={{ backgroundColor: theme.primary, color: theme.text.inverse }}
                            >
                                Back to Home
                            </button>
                            <button
                                ...
                                style={{ backgroundColor: theme.surface, color: theme.text.primary, borderColor: theme.primary }}
                            >
                                Browse Products
                            </button>
                        </div>
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: theme.background }}>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold mb-4" style={{ color: theme.text.primary }}>Become a Vendor</h1>

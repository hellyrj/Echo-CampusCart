                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            return (
                                <div key={vendorOrder.vendorId} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    <div className="flex items-center mb-4">
                                        <Store className="w-5 h-5 mr-2" style={{ color: '#606C38' }} />
                                        <h2 className="text-lg font-semibold" style={{ color: '#283618' }}>
                                            ...
                                            {statusSteps.map((step, index) => (
                                                <div key={step.key} className="flex flex-col items-center relative z-10">
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                                                        step.completed ? '' : 'bg-gray-300 text-gray-500'
                                                    }`} style={step.completed ? { backgroundColor: '#606C38', color: '#FEFAE0' } : {}}>
                                            ...
                                            <div className="space-y-2">
                                                {vendorOrder.statusHistory.map((history, idx) => (
                                                    <div key={idx} className="flex items-start text-sm">
                                                        <div className="w-2 h-2 rounded-full mt-1.5 mr-2" style={{ backgroundColor: '#606C38' }}></div>
                                                        <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            <h3 className="font-semibold mb-3 flex items-center" style={{ color: '#283618' }}>
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            <h3 className="font-semibold mb-3 flex items-center" style={{ color: '#283618' }}>
                                <Phone className="w-4 h-4 mr-1" style={{ color: '#606C38' }} />
                                Contact Information
                            </h3>
                            <div className="space-y-2 text-sm">
                                <p className="text-gray-600">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            <h3 className="font-semibold mb-3 flex items-center" style={{ color: '#283618' }}>
                                <CreditCard className="w-4 h-4 mr-1" style={{ color: '#606C38' }} />
                                Payment
                            </h3>
                            <div className="space-y-2 text-sm">
                                <p className="text-gray-600">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between font-bold text-lg border-t border-gray-200 pt-2">
                                    <span style={{ color: '#283618' }}>Total</span>
                                    <span style={{ color: '#606C38' }}>ETB {order.orderSummary?.grandTotal?.toFixed(2)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                            ...
                            <textarea
                                ...
                                rows="3"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-4 focus:ring-2 focus:ring-[#606C38]"
                            />

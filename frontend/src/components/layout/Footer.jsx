      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-bold mb-4 text-blue-400">CampusCart</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop shop for campus essentials. Making student life easier, one delivery at a time.
            </p>

...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const mockStats = {
      ...
      totalProducts: 45,
      recentOrders: [
        { id: 1, customer: 'John Doe', amount: 89.99, status: 'completed', date: '2024-03-15' },
        { id: 2, customer: 'Jane Smith', amount: 45.50, status: 'pending', date: '2024-03-15' },
        { id: 3, customer: 'Bob Johnson', amount: 120.00, status: 'processing', date: '2024-03-14' },
        { id: 4, customer: 'Alice Brown', amount: 67.75, status: 'completed', date: '2024-03-14' },
      ]
    };
